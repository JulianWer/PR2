...
public class BinaryTree1stTest {
	...
	/*
	 * @Test public void difficultTestsInputFromFile() throws Exception { //
	 * schwierige Tests: Löschen, Clone
	 * 
	 ...
	 * tree1.contains(new IntElement(10))); // testet, dass Änderungen im Klon sich
	 * nicht auf Original auswirken
	 * 
	 ...
	 * tree1.insertFromFile(filename);
	 * 
	 * tree2 = tree1.clone(); // tree2 ist Klon von tree1 tree1.addAll(tree2); //
	 * Füge denselben Baum (tree2) in tree1 ein. assertEquals(tree1.size(),
	 * tree2.size());
	 * 
	 * }
	 */
