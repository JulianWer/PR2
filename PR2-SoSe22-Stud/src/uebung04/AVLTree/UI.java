...
public class UI {
    ...
    private void showMainMenuOption(){
        println("Welcome on the AVL-Tree Menue!");
    ...
    private void createNewTree(){
        this.trees.add(new AVLTree());
        println("A new AVL-Tree was created");
    }
    ...
    private void showOptionsForTree(AVLTree btree){
        ...
        do { // run as long as checkdo is true
            ...
            switch(selection){
                ...
                case(10):
                    if (btree.isEmpty()) {
                        println("AVL tree is Empty");
                    } else {
                        println("AVL tree is not Empty");
                    }
                    break;
                case(11):
                    btree.clear();
                ...
                case(16):
                    ...
                    break;
                case(17):
                    this.trees.add((AVLTree) btree.clone());
                ...
                case(19):
                    ...
                    break;
                case(20):
                    this.trees.add((AVLTree) btree.createTree());
